...
class TrainBwStnTest {
    ...
    @Test
    @DisplayName("Successful Train Search Between Stations")
    void testDoPost_Success() throws ServletException, IOException {
        ...
        verify(mockPrintWriter).println(contains("Trains BetWeen Station"));
    }

    @Test
    @DisplayName("Train Search - No Trains Found")
